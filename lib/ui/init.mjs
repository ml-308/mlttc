...
class HcwInput extends HTMLElement {
    ...
    constructor() {
        ...
        const raw_props = ['accept', 'alt', 'checked', 'formaction', 'max', 'maxlength', 'min', 'minlength', 'step', 'name', 'type', 'value', 'placeholder', 'disabled', 'type', 'required', 'autocomplete', 'autocapitalize', 'style', 'onchange', 'readonly'];
        raw_props.forEach(prop => {
            Object.defineProperty(this, prop, {
...
class HcwTextarea extends HTMLElement {
    ...
    constructor() {
        ...
        const raw_props = ['name', 'value', 'placeholder', 'disabled', 'required', 'style', 'onchange', 'readonly'];
        raw_props.forEach(prop => {
            Object.defineProperty(this, prop, {
                get: () => this.#input.getAttribute(prop),
                set: (val) => this.#input.setAttribute(prop, val),
                enumerable: true,
                configurable: true
            });
            // this[prop] = this.getAttribute(prop);
